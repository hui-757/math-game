<template>
  <div class="select-page">
    ...
    <div class="bottom-actions">
      ...
      <button class="btn" v-else-if="authStore.isTeacher" @click="$router.push('/teacher')">班级管理</button>
      <button class="btn" v-else-if="!authStore.isLoggedIn" @click="$router.push('/auth')">教师登录</button>
    </div>
  </div>
</template>
